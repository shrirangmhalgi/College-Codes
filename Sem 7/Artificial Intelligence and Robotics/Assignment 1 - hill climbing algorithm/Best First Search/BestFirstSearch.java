...
//		}
//		
//		int currentNode = startNode, parentNode;
//		Map<Integer, Integer> closedList = new HashMap<Integer, Integer>();
//		ArrayList<Node> openList = new ArrayList<Node>();
//		Node node = new Node(currentNode, currentNode, heuristicFunction[currentNode]);
//		openList.add(node);
//		
...
//						node.setValue(heuristicFunction[i]);
//						openList.add(node);
//					}
//				}
...
//		-----------------------------------------------------------------------------------------------
		try {
			File file = new File("src/com/bestFirstSearch/input_best_first_search.txt");
